...
export default class News extends Component {
    ...
    async componentDidMount(){
      console.log("cdm");
      let url= "https://newsapi.org/v2/top-headlines?country=in&sortBy=publishedAt&apiKey=acc93718e32a44c79ab16ebbcc146b46";
      ...
      <div className="container my-3" >
        ...
        { this.state.articles.map(( element )=>{ 
            return <div className="col-md-4" key={ element.url } >
                <Newsitems title={ element.title?element.title.slice( 0,45 ):" " } description={ element.description?element.description.slice( 0,97 ):" " } imageUrl={ element.urlToImage?element.urlToImage : "data:image/jpeg;base64,"} newsUrl={ element.url}  />
            </div>
